...
//		NSString SPTAuthSessionUserDefaultsKey { get; }
	...
	[Protocol, Model]
	[BaseType (typeof(NSObject))]
	public interface SPTJSONObject
	{
	...
	public interface ISPTJSONObject : SPTJSONObject {
	}
	...
	public delegate void SPTRequestCallback (NSError arg0, NSObject track);

	// typedef void (^SPTRequestDataCallback)(NSError *, NSURLResponse *, NSData *);
	public delegate void SPTRequestDataCallback (NSError arg0, NSUrlResponse arg1, NSData arg2);
	...
	[Protocol,
	 BaseType (typeof(NSObject)),
	 Model]
	public interface SPTRequestHandlerProtocol
	{
	...
	interface SPTPlaylistList
	{
		...
		[Static]
		[Export ("createRequestForGettingPlaylistsFoUser:withAccessToken:error:")]
	...
	public interface SPTTrack : ISPTJSONObject
	{
		// @property (readonly, nonatomic) double popularity;
		[Export ("popularity")]
		double Popularity { get; }
...
//		unsafe void DisposeOfCustomNodesInGraph (AUGraph* graph);
		...
		// @property (readwrite, nonatomic, weak) id<SPTCoreAudioControllerDelegate> _Nullable delegate;
	...
	{
		// @required @property (nonatomic) NSURL * URI;
		[Export ("URI", ArgumentSemantic.Assign)]
		NSUrl URI { get; set; }

		// @required @property (nonatomic) NSString * itemID;
		[Export ("itemID")]
		...
		// @required @property (nonatomic) NSData * data;
	...
	interface SPTAudioStreamingController
	{
		...
		[Export ("initWithClientId:audioController:")]
		IntPtr Constructor (string clientId, SPTCoreAudioController audioController);

		// -(void)loginWithSession:(SPTSession *)session callback:(SPTErrorableOperationCallback)block;
		[Export ("loginWithSession:callback:")]
		void LoginWithSession (SPTSession session, SPTErrorableOperationCallback block);
		...
		// @property (nonatomic, weak) id<SPTAudioStreamingDelegate> _Nullable delegate;
		[NullAllowed, Export ("delegate", ArgumentSemantic.Weak)]
		NSObject WeakDelegate { get; set; }
		...
		// @property (nonatomic, weak) id<SPTAudioStreamingPlaybackDelegate> _Nullable playbackDelegate;
		...
		// [Verify (StronglyTypedNSArray)]
		void PlayURIs (NSObject[] uris, int index, SPTErrorableOperationCallback block);
		...
		// [Verify (StronglyTypedNSArray)]
		void PlayURIs (NSObject[] uris, SPTPlayOptions options, SPTErrorableOperationCallback block);

		// -(void)setURIs:(NSArray *)uris callback:(SPTErrorableOperationCallback)block __attribute__((deprecated("")));
		[Export ("setURIs:callback:")]
		// [Verify (StronglyTypedNSArray)]
		void SetURIs (NSObject[] uris, SPTErrorableOperationCallback block);
		...
		// [Verify (StronglyTypedNSArray)]
		void ReplaceURIs (NSObject[] uris, int index, SPTErrorableOperationCallback block);
		...
		// [Verify (StronglyTypedNSArray)]
		void QueueURIs (NSObject[] uris, bool clear, SPTErrorableOperationCallback block);
